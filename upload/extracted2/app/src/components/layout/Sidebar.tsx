...
import { LayoutGrid, TrendingUp, Calendar, Settings, Plus, Menu, X } from 'lucide-react';
import { useStore } from '@/store/useStore';
import type { PageView } from '@/types';
import { useState, useEffect } from 'react';

const navItems: { label: string; icon: React.ElementType; page: PageView; path: string }[] = [
  { label: 'Dashboard', icon: LayoutGrid, page: 'dashboard', path: '/dashboard' },
  { label: 'Analytics', icon: TrendingUp, page: 'analytics', path: '/analytics' },
  { label: 'Recurring', icon: Calendar, page: 'recurring', path: '/recurring' },
  { label: 'Settings', icon: Settings, page: 'settings', path: '/settings' },
];
